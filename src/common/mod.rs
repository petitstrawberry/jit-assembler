...
impl<I: Instruction, R: Register> InstructionCollectionWithUsage<I, R> {
    ...
    pub fn extend_from(&mut self, other: &InstructionCollectionWithUsage<I, R>) {
        self.instructions
            .extend_from_collection(&other.instructions);
        self.register_usage.merge(&other.register_usage);
    }
...
impl<I: Instruction, R: Register> core::ops::Add for InstructionCollectionWithUsage<I, R> {
    ...
    fn add(
        self,
        other: InstructionCollectionWithUsage<I, R>,
    ) -> InstructionCollectionWithUsage<I, R> {
        self.concat(other)
    }
}
...
pub trait InstructionBuilder<I: Instruction> {
    ...
    /// The error type for this builder
    type Error;
    ...
    fn instructions(&self) -> Result<InstructionCollection<I>, Self::Error>;

    /// Set an error without breaking the fluent chain
...
pub mod jit {
    ...
    impl<A1, A2, R> CallableJitFunction<fn(A1, A2) -> R> {
        ...
        pub fn call(&self, arg1: A1, arg2: A2) -> R {
            let func: extern "C" fn(A1, A2) -> R =
                unsafe { std::mem::transmute_copy(&self.exec_ptr) };
            func(arg1, arg2)
        }
    }
    ...
    impl<A1, A2, A3, R> CallableJitFunction<fn(A1, A2, A3) -> R> {
        ...
        pub fn call(&self, arg1: A1, arg2: A2, arg3: A3) -> R {
            let func: extern "C" fn(A1, A2, A3) -> R =
                unsafe { std::mem::transmute_copy(&self.exec_ptr) };
            func(arg1, arg2, arg3)
        }
    }
    ...
    impl<A1, A2, A3, A4, R> CallableJitFunction<fn(A1, A2, A3, A4) -> R> {
        ...
        pub fn call(&self, arg1: A1, arg2: A2, arg3: A3, arg4: A4) -> R {
            let func: extern "C" fn(A1, A2, A3, A4) -> R =
                unsafe { std::mem::transmute_copy(&self.exec_ptr) };
    ...
    impl<A1, A2, A3, A4, A5, R> CallableJitFunction<fn(A1, A2, A3, A4, A5) -> R> {
        ...
        pub fn call(&self, arg1: A1, arg2: A2, arg3: A3, arg4: A4, arg5: A5) -> R {
            let func: extern "C" fn(A1, A2, A3, A4, A5) -> R =
                unsafe { std::mem::transmute_copy(&self.exec_ptr) };
    ...
    impl<A1, A2, A3, A4, A5, A6, R> CallableJitFunction<fn(A1, A2, A3, A4, A5, A6) -> R> {
        ...
        pub fn call(&self, arg1: A1, arg2: A2, arg3: A3, arg4: A4, arg5: A5, arg6: A6) -> R {
            let func: extern "C" fn(A1, A2, A3, A4, A5, A6) -> R =
                unsafe { std::mem::transmute_copy(&self.exec_ptr) };
    ...
    impl<A1, A2, A3, A4, A5, A6, A7, R> CallableJitFunction<fn(A1, A2, A3, A4, A5, A6, A7) -> R> {
        ...
        pub fn call(
            ...
            let func: extern "C" fn(A1, A2, A3, A4, A5, A6, A7) -> R =
                unsafe { std::mem::transmute_copy(&self.exec_ptr) };
    ...
    impl std::fmt::Display for JitError {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            match self {
                JitError::AllocationFailed(e) => {
                    write!(f, "Failed to allocate JIT memory: {:?}", e)
                }
                JitError::BuildError(e) => {
    ...
    impl From<BuildError> for JitError {
        fn from(error: BuildError) -> Self {
            JitError::BuildError(error)
        }
    }
...
mod tests {
    ...
    fn test_instruction_collection_append() {
        let mut collection1 =
            InstructionCollection::from_slice(&[TestInstruction(1), TestInstruction(2)]);
        let collection2 =
            InstructionCollection::from_slice(&[TestInstruction(3), TestInstruction(4)]);
...
mod register_tracking_tests {
    ...
    fn test_instruction_collection_with_usage_append() {
        ...
        assert!(tracked1
            .register_usage()
            .contains_written_register(&TestRegister::T0));
        assert!(tracked1
            .register_usage()
            .contains_read_register(&TestRegister::S0));
    }
    ...
    fn test_instruction_collection_with_usage_multiple_merge() {
        ...
        let main_instrs =
            InstructionCollection::from_slice(&[TestInstruction(0x20), TestInstruction(0x21)]);
